        ...
        */
        if($loggedIn && $_SERVER["REQUEST_METHOD"] == "POST")
        {
            ...
            if(isset($_POST["edit"]))
            {
                ...
                if(!$id_if_route_exists || $id == $id_if_route_exists)
                {
                    ...
                    elseif($updateResult)
                    {
                        ...
                        $messageInfo = "Rota Ayrıntıları Düzenlendi";
                    }
                    else{
                        // Show error alert
            ...
            if(isset($_POST["delete"]))
            {
                ...
                {   
                    ...
                    // Show success alert
                    $messageStatus = "success";
                    $messageInfo = "Rota Detayları Silindi";
                    $messageHeading = "Başarılı!";
            ...
            if(!mysqli_num_rows($resultSqlResult)){ ?>
                ...
                <div class="container mt-4">
                    <div id="noRoutes" class="alert alert-dark " role="alert">
                        <h1 class="alert-heading">Rota Bulunamadı!!</h1>
                        <p class="fw-light">Hadi Bir tane Ekle</p>
                        <hr>
                        <div id="addRouteAlert" class="alert alert-success" role="alert">
                                Tıkla <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">ADD <i class="fas fa-plus"></i></button> Rota Eklemek İçin
                        </div>
                    </div>
                </div>
            <?php }
                ...
                <section id="route">
                    ...
                    <div id="route-results">
                        <div>
                            <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">Rota Ekle <i class="fas fa-plus"></i></button>
                        </div>
            ...
            <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Rota Ekle</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="addRouteForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            <div class="mb-3">
                                    <label for="viaCities" class="form-label">Şehirler Yoluyla</label>
                            ...
                            <div class="mb-3">
                                <label for="busno" class="form-label">Otobüs Numarası</label>
                            ...
                            <div class="mb-3">
                                <label for="stepCost" class="form-label">Maliyet</label>
                                <input type="number" class="form-control" id="stepCost" name="stepCost" required>
                            </div>
                            <div class="mb-3">
                                <label for="date" class="form-label">Kalkış Günü</label>
                            ...
                            <div class="mb-3">
                                <label for="time" class="form-label">Kalkış Zamanı</label>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body">
                ...
                <p>
                Gerçekten bu müşteri detaylarını silmek istiyor musunuz? <strong>Bu işlem geri alınamaz.<strong>This process cannot be undone.</strong>
                </p>
                <!-- Needed to pass id -->
