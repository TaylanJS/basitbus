        ...
        if($loggedIn && $_SERVER["REQUEST_METHOD"] == "POST")
        {
            ...
            if(isset($_POST["edit"]))
            {
                ...
                if(!$id_if_customer_exists || $customer_id == $id_if_customer_exists)
                {
                    ...
                    if(!$rowsAffected)
                    {
                        $messageInfo = "Hiçbir Düzenleme Yapılmadı!";
                    }
                    ...
                    elseif($updateResult)
                    {
                        ...
                        $messageInfo = "
                        Müşteri ayrıntıları Düzenlendi";
                    }
                    else{
                        
                        $messageInfo = "Talebiniz tarafımızdan kaynaklanan teknik sorunlar nedeniyle işleme alınamadı. Verdiğimiz rahatsızlıktan dolayı üzgünüz
                        ";
                    }
            ...
            if(isset($_POST["delete"]))
            {
                ...
                {   
                    $messageStatus = "success";
                    $messageInfo = "Rezervasyon Detayları silindi";
                    $messageHeading = "Başarılı!";
        ...
        <?php
            ...
            if(!mysqli_num_rows($resultSqlResult)){ ?>
                ...
                <div class="container mt-4">
                    <div id="noCustomers" class="alert alert-dark " role="alert">
                        <h1 class="alert-heading">Rezervasyon Bulunamadı!!</h1>
                        <p class="fw-light">Bir tane ekleyen ilk kişi olun!</p>
                        <hr>
                        <div id="addCustomerAlert" class="alert alert-success" role="alert">
                                 <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">EKLE <i class="fas fa-plus"></i></button> Rezervasyon eklemek için! Tıkla
                        </div>
                    </div>
                </div>
            <?php }
            ...
            <section id="booking">
                ...
                <div id="booking-results">
                    <div>
                        <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">Rezervasyon Ekle<i class="fas fa-plus"></i></button>
                    </div>
                    <table class="table table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <button class="button btn-sm edit-button" data-link="<?php echo $_SERVER['REQUEST_URI']; ?>" data-customerid="<?php 
                                                ...
                                                echo $customer_phone;?>" >Düzenle</button>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-scrollable">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Rezervasyon Yap</h5>
                    ...
                    <div class="modal-body">
                        <form id="addBookingForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="cid" class="form-label">Müşteri ID</label>
                            ...
                            <div class="mb-3">
                                <label for="cname" class="form-label">Müşteri Adı</label>
                            ...
                            <div class="mb-3">
                                <label for="sourceSearch" class="form-label">Kaynak</label>
                                <!-- Search Functionality -->
                                <div class="searchQuery">
                            ...
                            <div class="mb-3">
                                <label for="destinationSearch" class="form-label">Varış noktası</label>
                                <!-- Search Functionality -->
                                <div class="searchQuery">
                            ...
                            <div class="row g-3 align-items-center mb-3">
                                <div class="col-auto">
                                    <label for="seatInput" class="col-form-label">Koltuk numarası</label>
                                </div>
                                <div class="col-auto">
                                ...
                                <div class="col-auto">
                                    ...
                                    Yukarıdaki şekilden Maksimum 1 koltuk seçin.
                                    </span>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="bookAmount" class="form-label">Toplam Tutar</label>
                                <input type="text" class="form-control" id="bookAmount" name="bookAmount" readonly>
                            </div>
                            <button type="submit" class="btn btn-success" name="submit">Onayla</button>
                        </form>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body">
                ...
                <p>
                Bu rezervasyonu gerçekten silmek istiyor musunuz?<strong> Geri Dnüşü Olmaz.</strong>
                </p>
