                ...
                <div>
                    <div id="signupForm">
                        ...
                        <form action="../assets/partials/_handleSignup.php" method="POST">
                            ...
                            <div>
                                <input id="password" type="password" name="password" placeholder="Parola*" required>
                                <span id="passwordErr" class="error"></span>
                            </div>
                            <div>
                                <input id="confPassword" type="password" name="confPassword" placeholder="Parolayı Onayla*" required>
                                <span id="confPassErr" class="error"></span>
                            </div>
                            <button id="signup-btn" type="submit" name="signup">EKLE</button>
                        </form>
                    </div>
                </div>
                <div>
