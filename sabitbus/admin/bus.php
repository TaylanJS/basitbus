        ...
        */
        if($loggedIn && $_SERVER["REQUEST_METHOD"] == "POST")
        {
            ...
            if(isset($_POST["edit"]))
            {
                ...
                if(!$id_if_bus_exists || $id == $id_if_bus_exists)
                {
                    ...
                    elseif($updateResult)
                    {
                        ...
                        $messageInfo = "Otobüs detayları güncellendi";
                    }
                    else{
                        // Show error alert
            ...
            if(isset($_POST["delete"]))
            {
                ...
                {   
                    ...
                    // Show success alert
                    $messageStatus = "success";
                    $messageInfo = "Otobüs Detayları Silindi";
                    $messageHeading = "Başarılı!";
        ...
        <?php
            ...
            if(!mysqli_num_rows($resultSqlResult)){ ?>
                ...
                <div class="container mt-4">
                    <div id="noCustomers" class="alert alert-dark " role="alert">
                        <h1 class="alert-heading">Otobüs Bulunamadı!!</h1>
                        <p class="fw-light">Ekleyen ilk kişi olun!</p>
                        <hr>
                        <div id="addCustomerAlert" class="alert alert-success" role="alert">
                                 <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">EKLE <i class="fas fa-plus"></i></button>Otobüs Eklemek İçin Tıkla
                        </div>
                    </div>
                </div>
            <?php }
            ...
            <section id="bus">
                ...
                <div id="bus-results">
                    <div>
                        <button id="add-button" class="button btn-sm" type="button"data-bs-toggle="modal" data-bs-target="#addModal">Otobüs Ekle <i class="fas fa-plus"></i></button>
                    </div>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        <form id="addBusForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            <div class="mb-3">
                                <label for="busnumber" class="form-label">Otobüs Numarası</label><br>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body">
                ...
                <p>
                   Gerçekten Otobüsü Silmek istiyor musun? <strong>Bu işlem Geri alınamaz.</strong>
                </p>
                <!-- Needed to pass id -->
