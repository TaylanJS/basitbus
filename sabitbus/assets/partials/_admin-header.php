...
<!-- <header>
    ...
    <main id="container">
        <div id="sidebar" style="background-color:purple">
            ...
            <ul id="options">
                ...
                <li class="option <?php if($page=='bus'){ echo 'active';}?>">
                    <a href="./bus.php">
                    <i class="fas fa-bus"></i> Otobüsler
                    </a>
                </li>
                <li class="option <?php if($page=='route'){ echo 'active';}?>">
                    <a href="./route.php">
                    <i class="fas fa-road"></i> Rotalar    
                    </a>
                </li>
                ...
                <li class="option <?php if($page=='seat'){ echo 'active';}?>">
                    <a href="./seat.php">
                    <i class="fas fa-th"></i> Koltuklar
                    </a>
                </li>
                <li class="option <?php if($page=='signup'){ echo 'active';}?>">
                    <a href="./signup.php">
                    <i class="fas fa-user-lock"></i> Yeni Admin Ekle       
                    </a>
                </li>
            </ul>
        </div>
        <div id="main-content">
            <section id="welcome">
                <ul>
                    <li class="welcome-item">Hoşgeldin, 
                        <span id="USER">
                            <?php 
                                echo $user_fullname;
                            ?>
                    ...
                    <li class="welcome-item">
                        <button id="logout" class="btn-sm">
                            <a href="../assets/partials/_logout.php">Çıkış Yap</a>
                        </button>
                    </li>
                </ul>
            </section>