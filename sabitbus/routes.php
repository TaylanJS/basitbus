...
<body>
    ...
    <header>
        <nav id="navbar">
            <ul>
                <li><a href="index.php" class="nav-item">ANASAYFA</a></li>
    ...
    <main id="container">
        <section id="searched-route">
            <ul>
                <li class="searched-route-item" id="">Toplam Sonuç : <span id="result-num">
                    <?php 
                        echo $count;
                    ?>
                </span></li>
            ...
            {?>
                <div class="container mt-4">
                    <div id="noRoutes" class="alert alert-dark " role="alert">
                        ...
                        <p class="fw-light">
                        Şu anda belirtilen rota için hizmet yok
                        </p>
                        <hr>
                        <div id="addCustomerAlert" class="alert alert-success" role="alert">
                        Yakın zamanda bu güzergahı hizmete açacağız
                        </div>
                    </div>
                </div>
            <?php }
                ...
                <div class="searched-container">
                    <div class="searched-result-item">
                        ...
                        <div class="route-desc" data-dest="<?php echo $destination_state; ?>">
                            ...
                            <p class="cities">
                                <?php if($viaCities){ ?>
                                    <span class="via">Aracılığıyla</span> 
                                    <?php 
                                        echo $viaCities;
                                }
                                else{ ?>
                                    <span class="via">Doğrudan</span>
                                <?php }
                                ?>
                            </p>
                        </div>
